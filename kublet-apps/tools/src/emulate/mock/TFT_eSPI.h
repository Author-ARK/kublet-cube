...
public:
  ...
  // Mirror real TFT_eSPI which has a `print(const String&)` overload — apps
  // using WiFi.localIP().toString() rely on this to compile. The mock used
  // to compile fine until we added Arduino-style String prints in the IP
  // footer; this overload restores parity.

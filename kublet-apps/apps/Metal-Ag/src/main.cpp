...
// (e.g., "Ag" → "Ag", "xagusd" → "xagusd", COIN_COLOR → silver).
static const char *COIN_TICKER = "Ag-USD";
static const char *COIN_SYMBOL = "xagusd";  // Stooq symbol (lowercase)
#define COIN_COLOR 0xC618  // light silver
// =============================================================================
...
void drawChart() {
  // Big "Ag" badge sits on the left edge of the chart band, vertically
